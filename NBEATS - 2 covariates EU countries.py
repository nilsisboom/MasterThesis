...
read_test= pd.read_csv('data/env_wastrt_linear.csv.gz', header=[0], compression='gzip')
...
ax.legend(loc='lower center', fontsize=12,frameon=True, framealpha=0.7)
...
ax.set_ylabel(r'Recycling rate [$\%$]', fontsize=14,fontweight='bold')
