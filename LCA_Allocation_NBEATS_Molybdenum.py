...
Price_model_val = NBEATSModel(
    input_chunk_length=112, output_chunk_length=1, n_epochs=89, random_state=0, 
)
...
axs[2].plot(decomposition.index, decomposition['Residual'], label='Residual',  color='darkblue')
...
# Save the figure
plt.savefig('Decomposition_NBEATS_Molybdenum.png', dpi=300)
plt.show()
#%% forecast plot
...
ax.set_ylabel(r'Molybdenum Price [$\$/kg$]', fontsize=14)

plt.savefig('NBEATS_forecast_Molybdenum_economic_allocation.png', dpi=300)
...
plt.savefig('NBEATS_performance_plot_Molybdenum_economic_allocation.png',dpi=300)
