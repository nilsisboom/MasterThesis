...
#         'n_epochs':int(random.uniform(120,150)),
#         'input_chunk_length': int(random.uniform(80,120)),
#     }
...
print('input = 88', 'out= 8', 'epoch=147')

#%% predict during test period
pred = Price_model_test.predict(n=76)
...
decomposition_test_forecast = seasonal_decompose(pred_df)
...
# Save the figure
#plt.savefig('Decomposition_LSTM_Molybdenum.png', dpi=300)
plt.show()
#%% forecast plot
...
ax.set_ylabel('Molybdenum Price [$/kg]', fontsize=14)
...
#plt.savefig('LSTM_RNN_forecast_Molybdenum_economic_allocation.png', dpi=300)
...
#plt.savefig('LSTM_RNN_performance_plot_Molybdenum_economic_allocation.png',dpi=300)
...
#%% Calculate historic and future averages
