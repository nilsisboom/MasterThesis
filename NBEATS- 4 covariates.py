...
axs[1].set_title("Seasonal", fontsize=16)  # Add a title
...
axs[2].set_title("Residual", fontsize=16)  # Add a title
...
#plt.savefig('NBEATS_Recycling_rate_forecast.png', dpi=600, bbox_inches='tight')


# Save the plot with the desired figure size
plt.savefig('NBEATS_4_co_variates.png', dpi=300)
