# -*- coding: utf-8 -*-
"""
Created on Fri Oct 13 16:50:28 2023
...
plt.savefig('ACF and PACF for Copper ARIMA.png', dpi=300)
plt.show()
...
#plt.savefig('ARIMA_performance_plot_copper_economic_allocation.png',dpi=300)
...
#plt.savefig('ARIMA_forecast_Copper_economic_allocation.png', dpi=300)
...
# Save the figure
#plt.savefig('Decomposition_ARIMA_Copper.png', dpi=300)
plt.show()
