...
# Save the figure
#plt.savefig('Decomposition_LSTM_Copper.png', dpi=300)
plt.show()
#%% forecast plot
...
plt.savefig('LSTM_RNN_forecast_Copper_economic_allocation.png', dpi=300)
...
plt.savefig('LSTM_RNN_performance_plot_Copper_economic_allocation.png',dpi=300)
